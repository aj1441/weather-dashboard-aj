...
from weather_dashboard.core.utils import load_user_theme, save_user_theme
from weather_dashboard.core.api import fetch_weather_data
from weather_dashboard.core.data_handler import save_weather_data
from weather_dashboard.featues.charts import generate_temperature_chart
from weather_dashboard.featues.trends import analyze_trends
...
class WeatherDashboard:
    ...
    def setup_gui(self):
        ...
        # Theme toggle
        self.theme_var = tb.BooleanVar(value=(self.current_theme == "flatly"))
    ...
    def toggle_theme(self):
        ...
        if self.theme_var.get():
            ...
            self.app.style.theme_use("superhero")
